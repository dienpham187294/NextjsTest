...
function Manager() {
    ...
    return (
        <div >
            ...
            {PageChange % 2 === 0 ? <UpLoadFile SET_Data_InfoOflession={SET_Data_InfoOflession} SET_Data_TableTool={SET_Data_TableTool} SET_Data_Game={SET_Data_Game} />
                // : PageChange % 2 === 1 ? <InfoLession Data={Data_InfoOflession} />
                    : PageChange % 2 === 1 ? <GamePlay Data={Data_Game} Data_TableTool={Data_TableTool} />
                        : PageChange}
