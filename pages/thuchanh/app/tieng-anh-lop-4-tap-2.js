import Dulieu_tieng_anh_lop_4 from "../../../util/filedulieu/Dulieu_tieng_anh_lop_4_2";
import Head from "next/head";
import Show_Demo_Sentence_Basic from "../../../util/App/LEARN_SENTENC_Basic/Show_tieng_anh_lop_1";
export default function Show_tieng_anh_lop_4_tap_2() {
    return (
        <div>
            <Head>
                <title>Học tiếng anh lớp 4 tập 2 theo giáo trình của bộ giáo dục</title>
