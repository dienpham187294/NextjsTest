...
function ArrOfPeopeAppear_ReactJSX(props) {
    ...
    useEffect(
        () => {
            ...
            $("#IDDiv1").html(props.Total.stObj.DataSupport.huongdan)
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            props.Total.fnObj.SET_Avatar_Reactdata(null)
                                            // props.Total.fnObj.AddTo_Show_ArrOfPeopeAppear_ReactData(-1)
                                            try {
