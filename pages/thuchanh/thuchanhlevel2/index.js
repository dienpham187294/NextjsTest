...
function Manager() {
    ...
    const [DataSupport, SET_DataSupport] = useState([])
    const [huongdan, SET_huongdan] = useState("")
    const Total = new MDG(SET_PageChange, SET_Data_TableTool, SET_Data_Game, SET_Data_InfoOflession, SET_huongdan, SET_DataSupport, DataSupport)
    return (
        <div >
...
function MDG(
    ...
    this.fnObj = {
        ...
        "SET_DataSupport": SET_DataSupport
    }
    this.stObj = {
        "inputSumit": "",
