...
function _20chudehoctienganhquahinhanh() {
    ...
    return (
        <>
            <Head>
                <title>{"Học từ vựng tiếng anh online qua 20 chủ đề tiếng anh theo hình ảnh"}</title>
                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <meta name="description" content={"Học từ vựng tiếng anh online qua 20 chủ đề tiếng anh theo hình ảnh"} />
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <div className="container mt-1">
                {arr20chudetheohinhanh.map((e, index) =>
                    <>
                        <h5>Học từ vựng tiếng anh online qua 20 chủ đề tiếng anh theo hình ảnh</h5>
                        {e.map((ee, indexee) =>
                            <div
                                style={{
...
export default _20chudehoctienganhquahinhanh
