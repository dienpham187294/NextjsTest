...
function Giaotiepcoban() {

    return (
        <>
            <Head>
                <title>{"Học tiếng anh online 800 câu giao tiếp thông dụng nhất"}</title>
                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <meta name="description" content={"Học tiếng anh online 800 câu giao tiếp thông dụng nhất"} />
            ...
            <div className="container mt-3 p-1">
                ...
                <table className="table table-striped">
                    ...
                    <tbody>
                        {arr800cauthongdung.map((e, index) =>
                            <tr key={index}>
                                <td>{e.EN}</td>
                                <td>{e.VN}</td>
                            </tr>
