...
export default function A2_Thuytrang3(n) {
    ...
    ArrPeple.slice(0, n).forEach(e => {
        ...
        ArrOfSubmit.push("Yes")

        let howmany = pickNRandomElementsOfArray(Arri, 1)
        ArrOfSubmit.push(howmany[0].in2)
        ...
        let Body = [
            ...
            },
            {
                ...
                "handle": FnObjHanldingNext(
                    ...
                    ["Ok. Next Sunday also around 7pm please!"]
                ),
            },
            {
                "index": "0-0-0",
                "handle": FnObjHanldingNext(
                    ["Certainly. How many in your party, please?"],
                    [howmany[0].in1]
                ),
            },
            {
