...
let Arr3 = [
    {
        "in1": "Oh, one more thing. Any chance of a table outdoors?",
        "in2": "https://i.postimg.cc/fWGW9ydB/outdoor.png",
    },
    {
        "in1": "Oh, one more thing. Any chance of a table in the air conditioned room?",
...
export default function A2_Thuytrang2(n) {
    ...
    ArrPeple.slice(0, n).forEach(e => {
        ...
        let End2 = [
            FnObjHanldingNext(
                [
                    "I see, leave it to me. We will try our best. Is there anything else I can do for you?",
                ],
                ["No thanks, good bye!"]
            ),
            FnObjHanldingNext(
