...
let Arr1 = [
    {
        "input": "Very well.",
        "qs": ["Can you speak English?"],
        "output": ["I can speak English very well."]
    },
    {
        "input": "Communicate",
        "qs": ["Can you speak English?"],
        "output": ["I can express myself and communicate in English."]
    },
...
ARRp.forEach(e => {
    ...
    ArrInFN.gender = e[2]
    let ArrBegin = []
    ArrBegin.push(FnObjHanldingNext(["Hi"], ["hi", "hello"]))
...
export default CanyouspeakEnglish
