...
let Arr1 = [
    {
        "input": "Art",
        "qs": ["What’s your favorite subject?"],
        "output": ["My favorite subject is art."]
    },
    {
        "input": "Music",
        "qs": ["What’s your favorite subject?"],
        "output": ["My favorite subject is music."]
    },
...
ARRp.forEach(e => {
    ...
    ArrInFN.gender = e[2]
    let ArrBegin = []
    ArrBegin.push(FnObjHanldingNext(["Hi, how are you?"], ["Not too bad."]))
...
export default Whatsyourfavoritesubject
