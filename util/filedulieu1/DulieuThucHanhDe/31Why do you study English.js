...
let Arr1 = [
    {
        ...
        "qs": ["Why do you study English?", "Why are you studying English?"],
        "output": ["Because It’s very important and necessary."]
    },
    {
        "input": "Personal favorites",
        "qs": ["Why do you study English?", "Why are you studying English?"],
        "output": ["Because I love to improve my English skills."]
    },
]
Arr1.forEach(e => {
...
ARRp.forEach(e => {
    ...
    ArrInFN.gender = e[2]
    let ArrBegin = []
    ArrBegin.push(FnObjHanldingNext(["Hi, Can I ask you a question?"], ["Yes, of course."]))
...
const WhydoyoustudyEnglish
    = [
        {
            "nameoflession": "Lesson 31: Why do you study English?",
            "srcYoutube": "",
            "hoctap": [
            ],
            "status": "done",
...
export default WhydoyoustudyEnglish
