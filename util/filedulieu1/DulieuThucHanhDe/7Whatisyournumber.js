...
const Whatisyourphonenumber
    = [
        {
            "nameoflession": "Bài 4: Số điện thoại của bạn? -- what is your number?",
            "huongdan": "Tìm thông tin số điện thoại người đối thoại?",
            "hoctap": [
                { "EN": "What is your phone number?", "VN": "Số điện thoại của bạn là gì?", "IPA": "wɒt ɪz jɔː fəʊn ˈnʌmbə?", "IPAVN": "" },
                { "EN": "My phone number is 617098145.", "VN": "Số điện thoại của tôi là 617098145.", "IPA": "maɪ fəʊn ˈnʌmbər ɪz 617 098 145.", "IPAVN": "" },
                { "EN": "Can I have your new phone number?", "VN": "Cho tôi số điện thoại mới của bạn được không?", "IPA": "kæn aɪ hæv jɔː njuː fəʊn ˈnʌmbə?", "IPAVN": "" },
                { "EN": "Long time no see.", "VN": "Lâu rồi không gặp.", "IPA": "lɒŋ taɪm nəʊ siː.", "IPAVN": "" },
                { "EN": "Sorry but I have to go now.", "VN": "Xin lỗi nhưng tôi phải đi ngay bây giờ.", "IPA": "ˈsɒri bʌt aɪ hæv tuː gəʊ naʊ.", "IPAVN": "" },
                { "EN": "I will call you", "VN": "Tôi sẽ gọi cho bạn", "IPA": "aɪ wɪl kɔːl juː", "IPAVN": "" },
                { "EN": "That's no problem. See you later.", "VN": "Không vấn đề. Hẹn gặp lại.", "IPA": "ðæts nəʊ ˈprɒbləm. siː juː ˈleɪtə.", "IPAVN": "" },
            ],
        },
        {
            "coerdataoflession": [
