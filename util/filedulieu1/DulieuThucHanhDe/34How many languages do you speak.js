...
let Arr1 = [
    {
        "input": "2",
        "qs": ["How many languages do you speak?"],
        "output": ["I speak 2 languages."]
    },
    {
        "input": "3",
        "qs": ["How many languages do you speak?"],
        "output": ["I speak 3 languages."]
    },
    {
        "input": "4",
        "qs": ["How many languages do you speak?"],
        "output": ["I speak 4 languages."]
    },
    {
        "input": "5",
        "qs": ["How many languages do you speak?"],
        "output": ["I speak 5 languages."]
    }
]
Arr1.forEach(e => {
...
ARRp.forEach(e => {
    ...
    ArrInFN.gender = e[2]
    let ArrBegin = []
    ArrBegin.push(FnObjHanldingNext(["Hi, do you speak foreign languages?"], ["Yes"]))
...
export default Howmanylanguagesdoyouspeak
