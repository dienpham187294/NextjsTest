...
let Arr1 = [
    {
        "input": "Since I was 6.",
        "qs": ["How long have you learning English?"],
        "output": ["I’ve been learning English since I was 6."]
    },
    {
        "input": "10 years.",
        "qs": ["How long have you learning English?"],
        "output": ["I’ve been learning English for 10 years."]
    },
...
ARRp.forEach(e => {
    ...
    ArrInFN.gender = e[2]
    let ArrBegin = []
    ArrBegin.push(FnObjHanldingNext(["Hi, how are you?"], ["I am good."]))
...
const HowlonghaveyoulearningEnglish
    = [
        {
            "nameoflession": "Lesson 36: How long have you learning English?",
            "srcYoutube": "",
            "hoctap": [
            ],
            "status": "done",
...
export default HowlonghaveyoulearningEnglish
