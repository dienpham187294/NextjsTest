...
let Arr1 = [
    {
        "input": "University of Technology",
        "qs": ["Where do you study?"],
        "output": ["I am a student at Ho Chi Minh University of Technology"]
    },
    {
        "input": "International University",
        "qs": ["Where do you study?"],
        "output": ["I am a student at International University."]
    },
    {
        "input": "University of Science",
        "qs": ["Where do you study?"],
        "output": ["I am a student at University of Science."]
    },
    {
        "input": "University of Social Sciences and Humanities.",
        "qs": ["Where do you study?"],
        "output": ["I am a student at University of Social Sciences and Humanities."]
    },
]
Arr1.forEach(e => {
...
ARRp.forEach(e => {
    ...
    ArrInFN.gender = e[2]
    let ArrBegin = []
    ArrBegin.push(FnObjHanldingNext(["Hi, What do you do now?"], ["I'm studying at the university."]))
...
export default Wheredoyoustudy
