...
let Arr1 = [
    {
        "input": "Bus",
        "qs": ["How do you get to school?"],
        "output": ["I usually take the bus."]
    },
    {
        "input": "Bicycle",
        "qs": ["How do you get to school?"],
        "output": ["I ride my bicycle."]
    },
    {
        "input": "Car",
        "qs": ["How do you get to school?"],
        "output": ["My brother drives me to school by car."]
    },
]
Arr1.forEach(e => {
...
ARRp.forEach(e => {
    ...
    ArrInFN.gender = e[2]
    let ArrBegin = []
    ArrBegin.push(FnObjHanldingNext(["Hi, What are you doing?"], ["I'm getting ready for school."]))
...
const Howdoyougettoschool
    = [
        {
            "nameoflession": "Lesson 29: How do you get to school?",
            "srcYoutube": "",
            "hoctap": [
            ],
            "status": "done",
...
export default Howdoyougettoschool
