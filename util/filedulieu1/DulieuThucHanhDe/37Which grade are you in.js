...
let Arr1 = [
    {
        "input": "8",
        "qs": ["Which grade are you in?"],
        "output": ["I’m in 8th grade."]
    },
    {
        "input": "9",
        "qs": ["Which grade are you in?"],
        "output": ["I’m in 9th grade."]
    },
...
ARRp.forEach(e => {
    ...
    ArrInFN.gender = e[2]
    let ArrBegin = []
    ArrBegin.push(FnObjHanldingNext(["Hi, are you student?"], ["Yes I am."]))
...
export default Whichgradeareyouin
