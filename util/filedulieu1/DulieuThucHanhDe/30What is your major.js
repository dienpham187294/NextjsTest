...
let Arr1 = [
    {
        ...
        "qs": ["What is your major?"],
        "output": ["My major is Computer Science."]
    },
    {
        "input": "Cinema and Media Studies.",
        "qs": ["What is your major?"],
        "output": ["My major is Cinema and Media Studies."]
    },
    {
        "input": "Religious Studies.",
        "qs": ["What is your major?"],
        "output": ["My major is Religious Studies."]
    },
]
Arr1.forEach(e => {
...
ARRp.forEach(e => {
    ...
    ArrInFN.gender = e[2]
    let ArrBegin = []
    ArrBegin.push(FnObjHanldingNext(["Hi, Are you studying at university? ?"], ["Yes I am."]))
...
export default Whatisyourmajor
