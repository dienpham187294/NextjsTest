...
let Arr1 = [
    {
        "input": "A software engineer.",
        "qs": ["What do you want to do after you graduate?"],
        "output": ["I would like to be a software engineer."]
    },
    {
        "input": "A programmer.",
        "qs": ["What do you want to do after you graduate?"],
        "output": ["I want to be a programmer."]
    },
]
Arr1.forEach(e => {
...
export default Whatdoyouwanttodoafteryougraduate
