...
ArrPeple.forEach(e => {
    ...
    let ArrBegin = []
    ArrBegin.push(FnObjHanldingNext(["Hi, Where are you from?"], ["I live in " + arr_In1[i1]]))
    ...
    Arrin3.push("0")
    Arrin4.push(FnObjHanldingNext(["Where do you live?"], ["I live in " + arr_In1[i1]]))
...
const Bai33
    ...
    = [
        {
            "nameoflession": "Thực hành bài 3.3",
            "srcYoutube": "",
            "hoctap": {
                "listenRead": hoctap,
