...
let coerdataoflession = Bai21[1].coerdataoflession.slice(0, 15).concat(Bai22[1].coerdataoflession.slice(0, 15), Bai23[1].coerdataoflession.slice(0, 15))
let hoctap = [
...
const Bai24
    ...
    = [
        {
            "nameoflession": "Thực hành bài tổng hợp 2.1 + 2.2 + 2.3",
            "srcYoutube": "",
            "hoctap": {
                "listenRead": hoctap,
