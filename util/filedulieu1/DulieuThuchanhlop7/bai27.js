...
let coerdataoflession = Bai21[1].coerdataoflession.slice(0, 10).concat(Bai22[1].coerdataoflession.slice(0, 10), Bai23[1].coerdataoflession.slice(0, 10), Bai25[1].coerdataoflession.slice(0, 10), Bai26[1].coerdataoflession.slice(0, 10))
let hoctap = [
...
const Bai27
    ...
    = [
        {
            "nameoflession": "Thực hành bài tổng hợp 2.7 = 2.1 + 2.2 + 2.3 + 2.5 + 2.6",
            "srcYoutube": "",
            "hoctap": {
                "listenRead": hoctap,
